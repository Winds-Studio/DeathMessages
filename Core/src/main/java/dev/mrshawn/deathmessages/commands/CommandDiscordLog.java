...
public class CommandDiscordLog extends DeathMessagesCommand {
	...
	public void onCommand(CommandSender sender, String[] args) {
		...
		TextComponent discordConfig = Component.text()
				...
				.append(Component.text(Config.settings.HOOKS_DISCORD_ENABLED(), NamedTextColor.RED)).append(Component.newline())
				...
				.append(Component.text(Config.settings.HOOKS_DISCORD_CHANNELS_PLAYER_ENABLED(), NamedTextColor.RED)).append(Component.newline())
				.append(Component.text("    Player-Channels:", NamedTextColor.GREEN)).append(Component.newline())
				.append(Component.text("      - " + String.join("\n      - ", Config.settings.HOOKS_DISCORD_CHANNELS_PLAYER_CHANNELS()))).append(Component.newline())
				// Mob
				.append(Component.text("    Mob-Enabled: ", NamedTextColor.GREEN))
				.append(Component.text(Config.settings.HOOKS_DISCORD_CHANNELS_MOB_ENABLED(), NamedTextColor.RED)).append(Component.newline())
				.append(Component.text("    Mob-Channels:", NamedTextColor.GREEN)).append(Component.newline())
				.append(Component.text("      - " + String.join("\n      - ", Config.settings.HOOKS_DISCORD_CHANNELS_MOB_CHANNELS()))).append(Component.newline())
				// Player
				.append(Component.text("    Natural-Enabled: ", NamedTextColor.GREEN))
				.append(Component.text(Config.settings.HOOKS_DISCORD_CHANNELS_NATURAL_ENABLED(), NamedTextColor.RED)).append(Component.newline())
				.append(Component.text("    Natural-Channels:", NamedTextColor.GREEN)).append(Component.newline())
				.append(Component.text("      - " + String.join("\n      - ", Config.settings.HOOKS_DISCORD_CHANNELS_NATURAL_CHANNELS()))).append(Component.newline())
				// Player
				.append(Component.text("    Entity-Enabled: ", NamedTextColor.GREEN))
				.append(Component.text(Config.settings.HOOKS_DISCORD_CHANNELS_ENTITY_ENABLED(), NamedTextColor.RED)).append(Component.newline())
				.append(Component.text("    Entity-Channels:", NamedTextColor.GREEN)).append(Component.newline())
				.append(Component.text("      - " + String.join("\n      - ", Config.settings.HOOKS_DISCORD_CHANNELS_ENTITY_CHANNELS())))
				.build();
